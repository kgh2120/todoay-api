...
import com.todoay.api.domain.auth.dto.AuthVerifyEmailTokenOnSignUpRequestDto;
...
class MailVerificationControllerTest {
    ...
    void verifyEmailTokenOnSignUp() {
        ...
        // when
        mailVerificationController.verifyEmailTokenOnSignUp(AuthVerifyEmailTokenOnSignUpRequestDto.builder().emailToken(emailToken).build());
